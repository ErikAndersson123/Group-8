...
public class PanelView extends JPanel {
    ClientLogic cl = new ClientLogic((Subject) Naming.lookup("rmi://192.168.32.3/Subject"));
...
public PanelView(int w, int h) throws Exception {
    ...
    public PanelView(int w, int h,int roomID,Chatroom r) throws Exception {
        ...
        t1.addActionListener(e->{
            ...
            try {
                cl.createMessage(new Message(ChatroomView.u.getUserID(), roomID, time, t1.getText(), ""));
